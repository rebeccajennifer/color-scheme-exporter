...
class VsCodeScheme(ColorScheme):
  ...
  def populate_replacement_map(self) -> str:
    ...
    , 'ACCENT_0' : StringUtils.int_to_hex6(self.accent_color0_)
    , 'ACCENT_1' : StringUtils.int_to_hex6(self.accent_color1_)
    , 'ACCENT_2' : StringUtils.int_to_hex6(self.accent_color2_)
